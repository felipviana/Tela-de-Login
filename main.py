...
l_linha = Label(frame_cima, text='', width=270, anchor=NW, font= ('Ivy 1'), bg=co2, fg=co4)
l_linha.place(x=10, y=45)

credenciais = ['joao', '123456789']

#funções de validação de senha e login---------
def verificar_senha():
    nome = e_nome.get()
    senha = e_pass.get()

    if nome == 'admin' and senha == 'admin':
        messagebox.showinfo('Login', 'Seja bem vindo Admin :D')
    elif credenciais[0] == nome and credenciais[1] == senha:
        messagebox.showinfo('Login', 'Seja bem vindo d volta '+credenciais[0])
